...
main: main.o MathHelper.o matrix3.o matrix4.o transform.o vector3.o vector4.o
	$(CXX) $(CXXFLAGS) $(LDFLAGS) -o main main.o MathHelper.o matrix3.o matrix4.o transform.o vector3.o vector4.o

main.o: main.cpp FreeImage.h MathHelper.h Matrix3.h Matrix4.h transform.h Vector3.h Vector4.h
...
tests: TestSuite.o CameraTests.o Camera.o MathHelperTests.o MathHelper.o Matrix3Tests.o matrix3.o Matrix4Tests.o matrix4.o TransformTests.o transform.o Vector3Tests.o vector3.o Vector4Tests.o vector4.o
